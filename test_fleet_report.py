...
def test_summary_does_not_crash_on_missing_reading():
    # A car with no last_service_km (like VOS-7788 in fleet_sample.json) must not
    # raise a KeyError; it should be treated as freshly serviced and not counted as due.
    fleet = [
        {"id": "VOS-4471", "odometer": 14900, "last_service_km": 0},
    ...
    assert result["due"] == 1   # only VOS-4471 is due; VOS-7788 has 0 km since service
